...
import com.muy.dubbo.order.mapper.SuperMapper;
...
@MapperScan(
    basePackages = {"com.muy.dubbo.order.mapper"},
...
public class MybatisConfig {
  ...
  public SqlSessionFactory sqlSessionFactory() {
    ...
    sqlSessionFactoryBean.setTypeAliasesPackage("com.muy.dubbo.order.entity");
    ...
    try {
      sqlSessionFactoryBean
          .setMapperLocations(
              resolver.getResources("classpath:com/muy/dubbo/order/mapper/*Mapper.xml"));
